...
module.exports = app => {
  ...
  app.post("/vehicles/addNewVehicle", checkToken, vehicles.addNewVehicle);
  app.put("/vehicles/updateExistingVehicle", checkToken, vehicles.updateExistingVehicle);
  app.post("/vehicles/toggleAutoCharge", checkToken, vehicles.toggleAutoCharge);
  app.delete("/vehicles/deleteVehicle/:id/:modify_by", checkToken, vehicles.deleteVehicle);
  app.post("/vehicles/createVehicleOwner", checkToken, vehicles.createVehicleOwner);
  app.put("/vehicles/updateVehicleOwner", checkToken, vehicles.updateVehicleOwner);
  app.get("/vehicles/getAllVehicleOwners", checkToken, vehicles.getAllVehicleOwners);
 // app.get("/vehicles/getVehicleOwnerById/:id", checkToken, vehicles.getVehicleOwnerById);
  app.delete("/vehicles/deleteVehicleOwner/:id/:modify_by", checkToken, vehicles.deleteVehicleOwner);

app.get("/vehicles_RB/getAllVehicles/:login_id", checkToken, vehicles.getAllVehicles_RB);
app.get("/vehicles_RB/getVehiclesByUserId/:userId?", checkToken, vehicles.getVehiclesByUserId_RB);
app.get("/vehicles_RB/getAllVehicleOwners", checkToken, vehicles.getAllVehicleOwners_RB);
app.get("/vehicles_RB/getVehicleOwnerById/:id", checkToken, vehicles.getVehicleOwnerById_RB);
};